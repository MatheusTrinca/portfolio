        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <a
                href="mailto:matheusfelipetrinca@gmail.com"
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">14 999014372</span>
              <a
                href="https://api.whatsapp.com/send?phone=5514999014372&text=Olá, tudo bem?"
                className="contact__button"
              >
                Me escreva
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">@igfelipemt</span>
              <a
                href="https://www.instagram.com/igfelipemt"
                className="contact__button"
              >
                Me escreva
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
